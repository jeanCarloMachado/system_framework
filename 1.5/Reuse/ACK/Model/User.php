<?php
	class Reuse_ACK_Model_User extends System_Db_Table_Abstract
	{
		protected $_name = "usuarios";
		protected $_passwordColumn = "nome";
		protected $_login = "senha";
		...
		public function create(array $set)
		{
			...
			if(!array_key_exists($this->_passwordColumn, $set)) {

				$password = new System_Auth_Password;
				$newPassword  = $password->generate();
				$set[$this->_passwordColumn] = $newPassword['encrypt'];
			}
