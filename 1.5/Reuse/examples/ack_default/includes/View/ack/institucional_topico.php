...
<? include_once('_header.php'); ?>
            ...
            <div id="breadcrumbs">
            	...
            	<ul>
                    ...
                    <li><span><em><? if ($tipoAcao=="incluir") { ?>Adicionar<? } ?><? if ($tipoAcao=="editar") { ?>Editar<? } ?> tópico</em></span></li>
                </ul>
            </div><!-- END breadcrumbs -->
            
            
            <div id="descricaoPagina">
            	<h2><? if ($tipoAcao=="incluir") { ?>Adicionar<? } ?><? if ($tipoAcao=="editar") { ?>Editar<? } ?> tópico</h2>
				<?
            ...
            <div class="parentFull">
                ...
                <div id="metatags" class="modulo metaTags" <? if ($tipoAcao=="incluir") { ?> style="display:none;"<? } ?>>
                	<div class="head">
                    	<button><em>Meta tags</em></button>
						<?
                            $modelTextos=new ACKtextos_Model();
