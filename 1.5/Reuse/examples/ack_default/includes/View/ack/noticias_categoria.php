...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <? include_once('_header.php'); ?> 
            ...
            <div id="breadcrumbs">
            	<a href="<? echo $endereco_site; ?>/ack/noticias/categorias" class="btnSeta voltarTopo" title="Voltar">Voltar</a>
            	<ul>
                	<li><a href="<? echo $endereco_site; ?>/ack/noticias" title="Institucional"><em>Notícias</em></a></li>
                	<li><a href="<? echo $endereco_site; ?>/ack/noticias/categorias" title="Institucional"><em>Grupos de notícias</em></a></li>
