<?php
    ...
    abstract class Reuse_Ack_View_Helper_Show_MainMenuEntry
    {
    	...
    	/**
    	 * mostra somente a parte de cima de uma categoria
    	 * @param unknown $controllerName
    	 * @throws Excption
    	 */
    	public static function runLink($controllerName)
    	{
    		$controller = new $controllerName;
    		...
    		global $endereco_site;
    			...
    			?>
    	    				<a href="<? echo $endereco_site; ?>/ack/<?= $classUrl ?>" class="subsub" ><?= $title ?></a>
    	   <?php 
    	    	}
    }
